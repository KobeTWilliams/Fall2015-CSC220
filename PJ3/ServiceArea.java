...
class ServiceArea {
  ...
  // define customer queue limit
    //customer is returned when it is over limit
  ...
  public Teller removeFreeTellerQ()
  {
	...
	// Add statetments
      Teller freeTeller = freeTellerQ.poll();
	return freeTeller;
  }
  ...
  public Teller removeBusyTellerQ() 
  {
	...
	// Add statetments
      Teller busyTeller = busyTellerQ.poll();
	return busyTeller;
  }
  ...
  public static void main(String[] args) {
        ...
        // create a ServiceArea and 4 tellers
